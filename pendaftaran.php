    ...
    <div class="container">
        <div class="row">
            <div class="header-section text-center">
                <h2>Form Pendaftaran Siswa Baru SMA N 4 Kota Padang</h2><br>
                ...
                <div class="form-group">
                    ...
                    <div class="row col-md-10">
                        ...
                        <div class="row col-md-10">
                            <h1>LAMPIRAN</h1><br>
                            <div class="row col-md-5">
                                <p style="font-style: italic">Lampiran Berkas ijazah dan skhun yang telah simpan dalam format .zip</p>
            ...
            if (isset($_POST['save'])) {
                ...
                move_uploaded_file($lokasi, "admin/assets/lampiran/$nama_file");
                ...
                window.location='index.php?page=terdaftar'
                </script>";
            }
